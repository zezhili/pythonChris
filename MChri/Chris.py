...
text.write("李某人", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(0, 130) 
text.color("dark green") 
text.write("祝大家", font=("Avenir", 30, "bold"), align="right") 
text.color("red") 
text.write("圣诞节快乐!", font=("Avenir", 30, "normal"), align="left") 
text.setx(90) 
